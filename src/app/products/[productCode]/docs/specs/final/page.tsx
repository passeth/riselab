...
// 기본 완제품 시험 항목
const DEFAULT_FINAL_TESTS: Omit<TestSpec, 'id'>[] = [
  ...
  { order: 3, test_item: "P         H", specification: "(25℃)", test_method: "EV-F-1008(0)", remarks: "" },
  { order: 4, test_item: "내   용   량", specification: "표시용량의 100%이상", test_method: "EV-F-1035(0)", remarks: "" },
  { order: 5, test_item: "사   용   감", specification: "표 준 품 에 준 함", test_method: "EV-F-1004(0)", remarks: "" },
  { order: 6, test_item: "안   정   성", specification: "반제품성적서 참조", test_method: "EV-F-1005(0)", remarks: "" },
  { order: 7, test_item: "미   생   물", specification: "반제품성적서 참조", test_method: "EV-F-1014(0)", remarks: "" },
];
    ...
    try {
      ...
      try {
        ...
        if (specsData && specsData.length > 0) {
          ...
          setTestSpecs(DEFAULT_FINAL_TESTS.map((t, idx) => ({ ...t, id: `default-${idx}` })));
        }
      } catch {
        setTestSpecs(DEFAULT_FINAL_TESTS.map((t, idx) => ({ ...t, id: `default-${idx}` })));
      }
