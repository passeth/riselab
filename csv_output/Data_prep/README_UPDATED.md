...
### 06_allergens_master.csv (8,836 rows)

**설명**: 향료 알러젠 정보 (15개 공급업체)
...
- `향료중농도%` - 향료 내 알러젠 농도
- `제품중농도%` - 제품 내 알러젠 농도
- `라벨링기준` - Leave-on: 0.001%, Rinse-off: 0.01%
...
**작성일**: 2026-02-01  
**세션 종료 시점**: 제조공정지시기록서 추출 완료, 추가 데이터 대기 중  
**진행률**: 데이터 마이그레이션 약 85% 완료 (추가 데이터 pending)
